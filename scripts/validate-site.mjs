...
const sitemap=await readFile(join(root,'sitemap-0.xml'),'utf8');for(const route of ['list-cleaner','uuid-generator','timestamp-converter','jwt-decoder','url-encoder','margin-calculator','quotation-builder'])assert.ok(sitemap.includes(`/tools/${route}`));
